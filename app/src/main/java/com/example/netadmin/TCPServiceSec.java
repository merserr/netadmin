...
public class TCPServiceSec extends Service {

    final String LOG_TAG = "==TCPServiceSEC==";
    ...
    class TCPConnect extends AsyncTask<Void, Integer, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                dataOutputStream.writeBytes(sendstring_first);

                mBufferIn = new BufferedReader(new InputStreamReader(socket.getInputStream()));
                //read input massage from buffer
                inputMassage = mBufferIn.readLine();
         //       Log.d(LOG_TAG, "inputMassageSEC = "+inputMassage);
